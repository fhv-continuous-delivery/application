...
public class AnalysisHandler {
	...
	public at.fhv.cicd.application.models.SentimentResult analyze(String text, String token) throws Exception {
		...
		if(text == null || "".equals(text)) {
			at.fhv.cicd.application.models.SentimentResult empty = new at.fhv.cicd.application.models.SentimentResult();
		...
		at.fhv.cicd.application.models.SentimentResult sentimentResult = new at.fhv.cicd.application.models.SentimentResult();
		if(confidence > 50f) {
